    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li><a href="{{ url('/absensi/') }}"><em class="fa fa-calendar">&nbsp;</em> Absensi Mahasiswa</a></li>
                ...
                <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                    ...
                    <ul class="children collapse" id="sub-item-1">
                        ...
                        <li><a class="" href="{{ url('/admin/mahasiswa')}}">
                            <span class="fa fa-angle-right">&nbsp;</span> Mahasiswa <span class="label label-info">{{App\Mahasiswa::all()->count()}}</span>
                            </a></li>
                        ...
                        <li><a class="" href="{{ url('/admin/guru')}}">
                            <span class="fa fa-angle-right">&nbsp;</span> Dosen <span class="label label-info">{{App\Guru::all()->count()}}</span>
                            </a></li>
