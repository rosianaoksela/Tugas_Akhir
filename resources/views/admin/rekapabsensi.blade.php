                            ...
                            <table id="absensi" class="table table-bordred table-striped">
                                ...
                                <tbody id="isi">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $res->nim}}</td>
                                        <td>{{ $res->nama}}</td>
                                        <!-- <td>{{ count(App\Absensi::where(['mahasiswa_id'=>$res->id_mahasiswa, 'status'=>'Hadir'])->get()) }}</td> -->
                                        <td>{{ count(App\Absensi::where(['mahasiswa_id'=>$res->id_mahasiswa, 'status'=>'Alfa'])->get()) }}</td>
                                        <td>{{ count(App\Absensi::where(['mahasiswa_id'=>$res->id_mahasiswa, 'status'=>'Izin'])->get()) }}</td>
                                        <td>{{ count(App\Absensi::where(['mahasiswa_id'=>$res->id_mahasiswa, 'status'=>'Sakit'])->get()) }}</td>
