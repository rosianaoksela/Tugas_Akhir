        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <td colspan="2"><button class="edit-button btn btn-default" data-aksi="siswa" data-nama="{{$resource->nama}}" data-id="{{$resource->id_siswa}}"  data-jk="{{$resource->jenis_kelamin}}" data-nim="{{$resource->nim}}" data-toggle="modal" data-target="#edit">Edit Data</button></td>
                </div>
                @endif
            </div>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="/siswa/" method="post">
                ...
                <input type="hidden" name="nim" value="{{$resource->nim}}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" disabled>
                            </div>
                        </div> 
                        <div class="col-lg-12">
                            <div class="form-group">
